...
DOCUMENTATION = '''
---
module: getcurrentdeployment
short_description: Get all the hosts from current JSA deployment"
'''
EXAMPLES = '''
...
"console_admin_password": {"required": True, "type": "str", "no_log": True}
    ...
    is_error, has_changed, result = getcurrentdeployment (module.params)
